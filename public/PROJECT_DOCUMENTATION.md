...
* **Invention Disclosures**: Log confidential research disclosures with client-side cryptographic envelope encryption.
...
* **FR-DISC-002 — Cryptographic Envelope Protection**: Sensitive disclosure abstracts and payloads must be encrypted client-side using AES-256-GCM before transmission.
...
| **Cryptography** | Web Crypto API (AES-256-GCM / SHA-256) | Zero-dependency client-side cryptographic security. |
...
| :--- | :--- | :--- | :--- |
| **Unauthorized Disclosure Exposure** | Low | High | Client-side AES-256-GCM envelope encryption & strict RBAC middleware. |
